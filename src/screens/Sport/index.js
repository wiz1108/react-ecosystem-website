...
import Frames from "../../assets/clubs/background_sport.png";
...
import LiveYourBest from "../../assets/clubs/live_your_best_sport.png";
  ...
  const onGetStarted = () => {
	...
	return (
		<div className="Div-Container">
			<header className='Header-Clubs-Sport' id="page-header">
				<div className="content-header">
					<div className="heading">
						<div className='d-flex justify-content-center'>
							<button
        				className="header-sport"
      				>
          ...
          <img className='Img-Header-Country' src={HeaderCountry} />
			...
			<img className="Img-Frames-Sport" src={Frames} />

      <div className='Div-Content'>
        <img className='Img-Live-Best' src={LiveYourBest} />
        <p className='P-Title Text-41 text-center'>Your sport club ecosystem is the heartbeat of your relationships with your fans and followers. Drive next level engagement, loyalty and growth in your community, to help them live their best life.</p>
        <p className='P-Title Text-41 poppins-medium text-center'><b>It's quick a free to create your whitelabeled bespoke ecosystem.</b></p>
        ...
        <div className='Div-Buttons mt-5'>
          <button className="Btn Btn-Red" onClick={onGetStarted}>
